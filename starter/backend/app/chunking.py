def chunk_transcript(entries, window_seconds=45):
    ...
    TODO:
    1. Walk through `entries` in order, accumulating text into the current window.
    ...
    3. Once the window has covered >= window_seconds of transcript, close it out:
       append {"text": ..., "start_seconds": ...} to your results list, then start a
       new window.
    4. Don't forget to flush whatever's left in the last (possibly short) window.
